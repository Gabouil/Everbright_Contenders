...
class Game():
    ...
    class Liste_mot():
        def __init__(self,game):
            ...
            self.rien_que_vous_ecouter_jouter = rien_que_vous_ecouter_jouter(self.game, "rien que vous écouter jouter","Groupe nominaux")
            self.voyou_a_la_petite_semaine = voyou_a_la_petite_semaine(self.game, "voyou à la petite semaine", "Groupe nominaux")
            ...
            self.ton_manque_dexperience = ton_manque_dexperience(self.game, "ton manque d'expérience", "Groupe nominaux")
            ...
            self.quel_rate = quel_rate(self.game, "quel raté", "Groupes Nominaux / complements")
            ...
            self.pimbeche = pimbeche(self.game, "pimbêche", "Groupes Nominaux / complements")
            ...
            self.vu_de_pres = vu_de_pres(self.game, "vu de près", "complements")
            ...
            self.cest_ca_que_taimes = cest_ca_que_taimes(self.game, "c'est ça que t'aimes", "complements")
            ...
            self.pour_sur = pour_sur(self.game, "pour sûr", "complements")
            ...
            self.as_lair_si_bete = as_lair_si_bete(self.game, "as l'air si bête", "Groupes verbaux")
